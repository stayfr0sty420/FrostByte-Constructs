...
module.exports = {
  ...
  async execute(_client, interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        { name: 'Daily / Bank', value: '`/daily` `/balance` `/deposit` `/withdraw` `/leaderboard` `/pay`', inline: false },
        ...
        { name: 'Profile Social', value: '`/profile follow` `/profile unfollow` `/followers` `/following`', inline: false },
