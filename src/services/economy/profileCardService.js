...
function createOverlaySvg({
  ...
  const socialMetricLabelY = socialLabelY + 26;
  const socialMetricValueY = socialMetricLabelY + 30;
  const relationshipLabelY = socialMetricValueY + 30 + sectionGap;
  ...
  return Buffer.from(`
    <svg width="${CARD_WIDTH}" height="${CARD_HEIGHT}" viewBox="0 0 ${CARD_WIDTH} ${CARD_HEIGHT}" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="966" y="564" text-anchor="end" fill="rgba(255,255,255,0.56)" font-family="Segoe UI, Arial, sans-serif" font-size="14">Generated by RoBot</text>
    </svg>
  `);
}
